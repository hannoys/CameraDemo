package cn.edu.gdmec.a07150817.camerademo;
...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SurfaceView mSurfaceView = (SurfaceView) this.findViewById(R.id.surfaceView1);//获取ui控件
    ...
    public void savaPicture(byte[] data){
        try{
            ...
            if(!file.exists()){
                file.createNewFile();//如果文件不存在就新建，那么上面那个拿来干嘛
            }
